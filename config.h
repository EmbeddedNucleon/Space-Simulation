...
public:
    ...
    double getZoomDistanceScale() const {return m_zoomDistanceScale;}

    //meters per pixel, between bodies
    double setZoomDistanceScale(double distanceScale) { m_zoomDistanceScale = m_distanceScale / distanceScale; }
    ...
    bool getTrajectoryToggle() { return m_trajectoryToggle; }
    void setTrajectoryToggle(bool trajectoryToggle) { m_trajectoryToggle = trajectoryToggle; }
    bool m_trajectoryToggle = false;
